...
namespace Dataloop
{
    public partial interface IInvoicesClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Dataloop.Invoice>>> ListAccountInvoicesAsResponseAsync(
            string account,
            string? status = default,
            string? fromDate = default,
            string? toDate = default,
