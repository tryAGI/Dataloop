...
namespace Dataloop
{
    public partial interface IDatasetItemAnnotationsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.APICommand>> ArchiveDatasetItemAnnotationToStorageAsResponseAsync(
            string datasetId,
            string itemId,
