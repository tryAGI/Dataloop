...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_CreatePipelinesByPipelineIdExecutionsRerunSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_CreatePipelinesByPipelineIdExecutionsRerunSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_CreatePipelinesByPipelineIdExecutionsRerunSecurityRequirement0,
            };
        partial void PrepareCreatePipelinesByPipelineIdExecutionsRerunArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string pipelineId);
        partial void PrepareCreatePipelinesByPipelineIdExecutionsRerunRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string pipelineId);
        partial void ProcessCreatePipelinesByPipelineIdExecutionsRerunResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreatePipelinesByPipelineIdExecutionsRerunAsync(
            string pipelineId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePipelinesByPipelineIdExecutionsRerunArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePipelinesByPipelineIdExecutionsRerunSecurityRequirements,
                operationName: "CreatePipelinesByPipelineIdExecutionsRerunAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePipelinesByPipelineIdExecutionsRerunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createPipelinesByPipelineIdExecutionsRerun",
                                methodName: "CreatePipelinesByPipelineIdExecutionsRerunAsync",
                                pathTemplate: "$\"/pipelines/{pipelineId}/executions/rerun\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePipelinesByPipelineIdExecutionsRerunResponse(
                    httpClient: HttpClient,
