...
namespace Dataloop
{
    public partial class ExecutionsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_UpdateExecutionSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_UpdateExecutionSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_UpdateExecutionSecurityRequirement0,
            };
        partial void PrepareUpdateExecutionArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Dataloop.APIExecutionPatch request);
        partial void PrepareUpdateExecutionRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Dataloop.APIExecutionPatch request);
        partial void ProcessUpdateExecutionResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateExecutionResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Dataloop.APIExecution> UpdateExecutionAsync(
            string id,
        ...
        {
            var __response = await UpdateExecutionAsResponseAsync(
                id: id,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.APIExecution>> UpdateExecutionAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateExecutionArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateExecutionSecurityRequirements,
                operationName: "UpdateExecutionAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateExecutionAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateExecutionResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateExecutionResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dataloop.APIExecution> UpdateExecutionAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Dataloop.APIExecutionPatch
            {
                Duration = duration,
                ServiceVersion = serviceVersion,
            };

            return await UpdateExecutionAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
