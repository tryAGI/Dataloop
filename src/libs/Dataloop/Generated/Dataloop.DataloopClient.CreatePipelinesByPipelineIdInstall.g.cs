...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_CreatePipelinesByPipelineIdInstallSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_CreatePipelinesByPipelineIdInstallSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_CreatePipelinesByPipelineIdInstallSecurityRequirement0,
            };
        partial void PrepareCreatePipelinesByPipelineIdInstallArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string pipelineId);
        partial void PrepareCreatePipelinesByPipelineIdInstallRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string pipelineId);
        partial void ProcessCreatePipelinesByPipelineIdInstallResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreatePipelinesByPipelineIdInstallAsync(
            string pipelineId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePipelinesByPipelineIdInstallArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePipelinesByPipelineIdInstallSecurityRequirements,
                operationName: "CreatePipelinesByPipelineIdInstallAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Dataloop.PathBuilder(
                                path: $"/pipelines/{pipelineId}/install",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePipelinesByPipelineIdInstallRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createPipelinesByPipelineIdInstall",
                                methodName: "CreatePipelinesByPipelineIdInstallAsync",
                                pathTemplate: "$\"/pipelines/{pipelineId}/install\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePipelinesByPipelineIdInstallResponse(
                    httpClient: HttpClient,
