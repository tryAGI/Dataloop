...
namespace Dataloop
{
    public partial class StructuresClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_UpdateStructureSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_UpdateStructureSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_UpdateStructureSecurityRequirement0,
            };
        partial void PrepareUpdateStructureArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string ontologyId,
            global::Dataloop.APIUpdateStructurePayload request);
        partial void PrepareUpdateStructureRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string ontologyId,
            global::Dataloop.APIUpdateStructurePayload request);
        partial void ProcessUpdateStructureResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessUpdateStructureResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dataloop.APIStructure> UpdateStructureAsync(
            string id,
            string ontologyId,
        ...
        {
            var __response = await UpdateStructureAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.APIStructure>> UpdateStructureAsResponseAsync(
            string id,
            string ontologyId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareUpdateStructureArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_UpdateStructureSecurityRequirements,
                operationName: "UpdateStructureAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Dataloop.PathBuilder(
                                path: $"/ontologies/{ontologyId}/structures/{id}",
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "UpdateStructureAsync",
                                pathTemplate: "$\"/ontologies/{ontologyId}/structures/{id}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessUpdateStructureResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessUpdateStructureResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dataloop.APIStructure> UpdateStructureAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Dataloop.APIUpdateStructurePayload
            {
                Order = order,
                Arcs = arcs,
                Name = name,
            ...
            return await UpdateStructureAsync(
                id: id,
                ontologyId: ontologyId,
                request: __request,
                requestOptions: requestOptions,
