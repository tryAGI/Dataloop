...
namespace Dataloop
{
    public partial class AuditClient
    {
        ...
        {
            await GetAuditLogsCsvAsResponseAsync(
                orgId: orgId,
                fromDate: fromDate,
                toDate: toDate,
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> GetAuditLogsCsvAsResponseAsync(
            string orgId,
            global::System.DateTime fromDate,
            global::System.DateTime toDate,
            string? id = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetAuditLogsCsv",
                                methodName: "GetAuditLogsCsvAsync",
                                pathTemplate: "\"/audit/logs/csv\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
