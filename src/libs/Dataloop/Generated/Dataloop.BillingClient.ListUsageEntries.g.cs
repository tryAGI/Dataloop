...
namespace Dataloop
{
    public partial class BillingClient
    {
        ...
        {
            var __response = await ListUsageEntriesAsResponseAsync(
                project: project,
                startDate: startDate,
                endDate: endDate,
                monthly: monthly,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Dataloop.APIUsageEntry>>> ListUsageEntriesAsResponseAsync(
            string project,
            string startDate,
            string endDate,
            string? monthly = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ListUsageEntries",
                                methodName: "ListUsageEntriesAsync",
