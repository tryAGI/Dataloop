...
namespace Dataloop
{
    public partial class PipelinesClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_Terminate2SecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_Terminate2SecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_Terminate2SecurityRequirement0,
            };
        partial void PrepareTerminate2Arguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string pipelineId);
        partial void PrepareTerminate2Request(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string pipelineId);
        partial void ProcessTerminate2Response(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTerminate2ResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> Terminate2Async(
            string pipelineId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await Terminate2AsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<string>> Terminate2AsResponseAsync(
            string pipelineId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_Terminate2SecurityRequirements,
                operationName: "Terminate2Async");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Dataloop.PathBuilder(
                                path: $"/pipelines/{pipelineId}/terminate",
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "Terminate2Async",
                                pathTemplate: "$\"/pipelines/{pipelineId}/terminate\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTerminate2ResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
