...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_CreateServicesByIdStatusSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_CreateServicesByIdStatusSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_CreateServicesByIdStatusSecurityRequirement0,
            };
        partial void PrepareCreateServicesByIdStatusArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareCreateServicesByIdStatusRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessCreateServicesByIdStatusResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreateServicesByIdStatusAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateServicesByIdStatusArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateServicesByIdStatusSecurityRequirements,
                operationName: "CreateServicesByIdStatusAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateServicesByIdStatusRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createServicesByIdStatus",
                                methodName: "CreateServicesByIdStatusAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateServicesByIdStatusResponse(
                    httpClient: HttpClient,
