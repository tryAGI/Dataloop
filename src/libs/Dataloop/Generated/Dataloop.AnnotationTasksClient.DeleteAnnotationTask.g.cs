...
namespace Dataloop
{
    public partial class AnnotationTasksClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_DeleteAnnotationTaskSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_DeleteAnnotationTaskSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_DeleteAnnotationTaskSecurityRequirement0,
            };
        partial void PrepareDeleteAnnotationTaskArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Dataloop.DeleteTaskPayload request);
        partial void PrepareDeleteAnnotationTaskRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Dataloop.DeleteTaskPayload request);
        partial void ProcessDeleteAnnotationTaskResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDeleteAnnotationTaskResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await DeleteAnnotationTaskAsResponseAsync(
                id: id,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.AnyOf<object, global::Dataloop.APICommand>>> DeleteAnnotationTaskAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteAnnotationTaskArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteAnnotationTaskSecurityRequirements,
                operationName: "DeleteAnnotationTaskAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteAnnotationTask",
                                methodName: "DeleteAnnotationTaskAsync",
                                pathTemplate: "$\"/annotationtasks/{id}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteAnnotationTaskResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDeleteAnnotationTaskResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dataloop.AnyOf<object, global::Dataloop.APICommand>.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::Dataloop.AnyOf<object, global::Dataloop.APICommand>>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dataloop.AnyOf<object, global::Dataloop.APICommand>.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Dataloop.AnyOf<object, global::Dataloop.APICommand>> DeleteAnnotationTaskAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Dataloop.DeleteTaskPayload
            {
                Asynced = asynced,
                DeleteWithPipeline = deleteWithPipeline,
                EmptyOnly = emptyOnly,
                Force = force,
            };

            return await DeleteAnnotationTaskAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
