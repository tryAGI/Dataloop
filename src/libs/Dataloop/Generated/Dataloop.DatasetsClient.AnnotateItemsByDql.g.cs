...
namespace Dataloop
{
    public partial class DatasetsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_AnnotateItemsByDqlSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_AnnotateItemsByDqlSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_AnnotateItemsByDqlSecurityRequirement0,
            };
        partial void PrepareAnnotateItemsByDqlArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            global::Dataloop.ClassifyFilteredItems request);
        partial void PrepareAnnotateItemsByDqlRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            global::Dataloop.ClassifyFilteredItems request);
        partial void ProcessAnnotateItemsByDqlResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task AnnotateItemsByDqlAsync(
            string id,
        ...
        {
            await AnnotateItemsByDqlAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> AnnotateItemsByDqlAsResponseAsync(
            string id,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareAnnotateItemsByDqlArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AnnotateItemsByDqlSecurityRequirements,
                operationName: "AnnotateItemsByDqlAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareAnnotateItemsByDqlRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AnnotateItemsByDql",
                                methodName: "AnnotateItemsByDqlAsync",
                                pathTemplate: "$\"/datasets/{id}/annotations\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAnnotateItemsByDqlResponse(
                    httpClient: HttpClient,
        ...
        public async global::System.Threading.Tasks.Task AnnotateItemsByDqlAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Dataloop.ClassifyFilteredItems
            {
                Query = query,
                Annotation = annotation,
            };

            await AnnotateItemsByDqlAsync(
                id: id,
                request: __request,
                requestOptions: requestOptions,
