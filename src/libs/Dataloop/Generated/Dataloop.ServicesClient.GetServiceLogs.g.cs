...
namespace Dataloop
{
    public partial class ServicesClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_GetServiceLogsSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_GetServiceLogsSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_GetServiceLogsSecurityRequirement0,
            };
        partial void PrepareGetServiceLogsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string verbose,
            global::Dataloop.LogQuery request);
        partial void PrepareGetServiceLogsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string verbose,
            global::Dataloop.LogQuery request);
        partial void ProcessGetServiceLogsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetServiceLogsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dataloop.ServiceLogsPage> GetServiceLogsAsync(
            string id,
            string verbose,
        ...
        {
            var __response = await GetServiceLogsAsResponseAsync(
                id: id,
                verbose: verbose,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.ServiceLogsPage>> GetServiceLogsAsResponseAsync(
            string id,
            string verbose,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetServiceLogsArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetServiceLogsSecurityRequirements,
                operationName: "GetServiceLogsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetServiceLogsAsync",
                                pathTemplate: "$\"/services/{id}/logs\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetServiceLogsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dataloop.ServiceLogsPage.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::Dataloop.ServiceLogsPage>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dataloop.ServiceLogsPage.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await GetServiceLogsAsync(
                id: id,
                verbose: verbose,
                request: __request,
                requestOptions: requestOptions,
