...
namespace Dataloop
{
    public partial class DatasetItemsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_StreamDatasetItemSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_StreamDatasetItemSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_StreamDatasetItemSecurityRequirement0,
            };
        partial void PrepareStreamDatasetItemArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id,
            ref string datasetId);
        partial void PrepareStreamDatasetItemRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string datasetId);
        partial void ProcessStreamDatasetItemResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task StreamDatasetItemAsync(
            string id,
            string datasetId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await StreamDatasetItemAsResponseAsync(
                id: id,
                datasetId: datasetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> StreamDatasetItemAsResponseAsync(
            string id,
            string datasetId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareStreamDatasetItemArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StreamDatasetItemSecurityRequirements,
                operationName: "StreamDatasetItemAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Dataloop.PathBuilder(
                                path: $"/datasets/{datasetId}/items/{id}/stream",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareStreamDatasetItemRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StreamDatasetItem",
                                methodName: "StreamDatasetItemAsync",
                                pathTemplate: "$\"/datasets/{datasetId}/items/{id}/stream\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStreamDatasetItemResponse(
                    httpClient: HttpClient,
