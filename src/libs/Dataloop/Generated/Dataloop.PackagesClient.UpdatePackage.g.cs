            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Dataloop.APIPackage.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Dataloop.APIPackage.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
