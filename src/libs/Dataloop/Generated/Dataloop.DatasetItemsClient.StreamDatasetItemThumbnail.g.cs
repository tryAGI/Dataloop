...
namespace Dataloop
{
    public partial class DatasetItemsClient
    {
        ...
        {
            await StreamDatasetItemThumbnailAsResponseAsync(
                id: id,
                datasetId: datasetId,
                width: width,
                height: height,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> StreamDatasetItemThumbnailAsResponseAsync(
            string id,
            string datasetId,
            double? width = default,
            double? height = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StreamDatasetItemThumbnail",
                                methodName: "StreamDatasetItemThumbnailAsync",
                                pathTemplate: "$\"/datasets/{datasetId}/items/{id}/thumbnail\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
