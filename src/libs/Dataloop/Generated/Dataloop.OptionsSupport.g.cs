...
namespace Dataloop
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Dataloop.AutoSDKRetryOptions Retry { get; set; } = new global::Dataloop.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Dataloop.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Dataloop.IAutoSDKHook>();
        ...
        public global::Dataloop.AutoSDKClientOptions AddHook(
            global::Dataloop.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Dataloop.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Dataloop.AutoSDKClientOptions UseAuthorizationProvider(
            global::Dataloop.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Dataloop.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Dataloop.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Dataloop.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Dataloop.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Dataloop.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Dataloop.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Dataloop.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Dataloop.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Dataloop.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Dataloop.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Dataloop.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Dataloop.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Dataloop.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Dataloop.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Dataloop.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Dataloop.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Dataloop.AutoSDKClientOptions clientOptions,
            global::Dataloop.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Dataloop.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Dataloop.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Dataloop.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Dataloop.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Dataloop.IAutoSDKHook, global::Dataloop.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Dataloop.AutoSDKHookContext context)
        {
