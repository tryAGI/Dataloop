...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_CreatePipelinesByPipelineIdUninstallSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_CreatePipelinesByPipelineIdUninstallSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_CreatePipelinesByPipelineIdUninstallSecurityRequirement0,
            };
        partial void PrepareCreatePipelinesByPipelineIdUninstallArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string pipelineId);
        partial void PrepareCreatePipelinesByPipelineIdUninstallRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string pipelineId);
        partial void ProcessCreatePipelinesByPipelineIdUninstallResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreatePipelinesByPipelineIdUninstallAsync(
            string pipelineId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePipelinesByPipelineIdUninstallArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePipelinesByPipelineIdUninstallSecurityRequirements,
                operationName: "CreatePipelinesByPipelineIdUninstallAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Dataloop.PathBuilder(
                                path: $"/pipelines/{pipelineId}/uninstall",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePipelinesByPipelineIdUninstallRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createPipelinesByPipelineIdUninstall",
                                methodName: "CreatePipelinesByPipelineIdUninstallAsync",
                                pathTemplate: "$\"/pipelines/{pipelineId}/uninstall\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePipelinesByPipelineIdUninstallResponse(
                    httpClient: HttpClient,
