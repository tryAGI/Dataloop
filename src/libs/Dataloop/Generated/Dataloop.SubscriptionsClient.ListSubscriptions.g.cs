...
namespace Dataloop
{
    public partial class SubscriptionsClient
    {
        ...
        {
            var __response = await ListSubscriptionsAsResponseAsync(
                account: account,
                org: org,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.CursorPageAPISubscription>> ListSubscriptionsAsResponseAsync(
            string? account = default,
            string? org = default,
            double? pageOffset = default,
            double? pageSize = default,
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ListSubscriptionsAsync",
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dataloop.CursorPageAPISubscription.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::Dataloop.CursorPageAPISubscription>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dataloop.CursorPageAPISubscription.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
