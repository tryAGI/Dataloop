            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Dataloop.AuditLogsCursorPage.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Dataloop.AuditLogsCursorPage.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
