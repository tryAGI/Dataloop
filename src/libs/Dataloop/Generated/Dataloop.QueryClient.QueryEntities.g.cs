...
namespace Dataloop
{
    public partial class QueryClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_QueryEntitiesSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_QueryEntitiesSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_QueryEntitiesSecurityRequirement0,
            };
        partial void PrepareQueryEntitiesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Dataloop.QueryEntitiesRequest request);
        partial void PrepareQueryEntitiesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Dataloop.QueryEntitiesRequest request);
        partial void ProcessQueryEntitiesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryEntitiesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await QueryEntitiesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryEntitiesSecurityRequirements,
                operationName: "QueryEntitiesAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "QueryEntitiesAsync",
                                pathTemplate: "\"/query/faas\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryEntitiesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<string> QueryEntitiesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Dataloop.QueryEntitiesRequest
            {
                PageSize = pageSize,
                Page = page,
                Sort = sort,
