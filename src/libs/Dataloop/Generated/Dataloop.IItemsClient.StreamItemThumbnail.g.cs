...
namespace Dataloop
{
    public partial interface IItemsClient
    {
        ...
        global::System.Threading.Tasks.Task StreamItemThumbnailAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> StreamItemThumbnailAsResponseAsync(
            string id,
            double? width = default,
            double? height = default,
            bool? annotations = default,
