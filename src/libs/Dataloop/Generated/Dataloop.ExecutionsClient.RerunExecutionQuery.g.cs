...
namespace Dataloop
{
    public partial class ExecutionsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_RerunExecutionQuerySecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_RerunExecutionQuerySecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_RerunExecutionQuerySecurityRequirement0,
            };
        partial void PrepareRerunExecutionQueryArguments(
            global::System.Net.Http.HttpClient httpClient,
            object request);
        partial void PrepareRerunExecutionQueryRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            object request);
        partial void ProcessRerunExecutionQueryResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRerunExecutionQueryResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await RerunExecutionQueryAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRerunExecutionQueryArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RerunExecutionQuerySecurityRequirements,
                operationName: "RerunExecutionQueryAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRerunExecutionQueryRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RerunExecutionQuery",
                                methodName: "RerunExecutionQueryAsync",
                                pathTemplate: "\"/executions/rerun\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRerunExecutionQueryResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRerunExecutionQueryResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await RerunExecutionQueryAsync(
                request: __request,
                requestOptions: requestOptions,
