...
namespace Dataloop
{
    public partial class DatasetStorageClient
    {


        private static readonly global::Dataloop.EndPointSecurityRequirement s_GetProjectSizeInBytesSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_GetProjectSizeInBytesSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_GetProjectSizeInBytesSecurityRequirement0,
            };
        partial void PrepareGetProjectSizeInBytesArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Dataloop.ProjectStorageRequest request);
        partial void PrepareGetProjectSizeInBytesRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Dataloop.ProjectStorageRequest request);
        partial void ProcessGetProjectSizeInBytesResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetProjectSizeInBytesResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<double> GetProjectSizeInBytesAsync(

            global::Dataloop.ProjectStorageRequest request,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetProjectSizeInBytesAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<double>> GetProjectSizeInBytesAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareGetProjectSizeInBytesArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetProjectSizeInBytesSecurityRequirements,
                operationName: "GetProjectSizeInBytesAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetProjectSizeInBytesRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetProjectSizeInBytes",
                                methodName: "GetProjectSizeInBytesAsync",
                                pathTemplate: "\"/datasets/storage/project\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetProjectSizeInBytesResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetProjectSizeInBytesResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<double> GetProjectSizeInBytesAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Dataloop.ProjectStorageRequest
            {
                ProjectId = projectId,
                External = external,
            };

            return await GetProjectSizeInBytesAsync(
                request: __request,
                requestOptions: requestOptions,
