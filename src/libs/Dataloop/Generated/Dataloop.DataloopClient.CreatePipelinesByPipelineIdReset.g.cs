...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_CreatePipelinesByPipelineIdResetSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_CreatePipelinesByPipelineIdResetSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_CreatePipelinesByPipelineIdResetSecurityRequirement0,
            };
        partial void PrepareCreatePipelinesByPipelineIdResetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string pipelineId);
        partial void PrepareCreatePipelinesByPipelineIdResetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string pipelineId);
        partial void ProcessCreatePipelinesByPipelineIdResetResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreatePipelinesByPipelineIdResetAsync(
            string pipelineId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreatePipelinesByPipelineIdResetArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreatePipelinesByPipelineIdResetSecurityRequirements,
                operationName: "CreatePipelinesByPipelineIdResetAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            var __pathBuilder = new global::Dataloop.PathBuilder(
                                path: $"/pipelines/{pipelineId}/reset",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreatePipelinesByPipelineIdResetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createPipelinesByPipelineIdReset",
                                methodName: "CreatePipelinesByPipelineIdResetAsync",
                                pathTemplate: "$\"/pipelines/{pipelineId}/reset\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreatePipelinesByPipelineIdResetResponse(
                    httpClient: HttpClient,
