...
namespace Dataloop
{
    public partial interface IDatasetItemsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.APIDatasetItemCursor>> GetDirectoryChildDatasetItemsAsResponseAsync(
            string id,
            string datasetId,
            double? pageOffset = default,
            double? pageSize = default,
