...
namespace Dataloop
{
    public partial class DatasetsClient
    {
        ...
        {
            var __response = await GetDatasetDirectoryTreeAsResponseAsync(
                id: id,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.DatasetDirectoryTree>> GetDatasetDirectoryTreeAsResponseAsync(
            string id,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetDatasetDirectoryTree",
                                methodName: "GetDatasetDirectoryTreeAsync",
                                pathTemplate: "$\"/datasets/{id}/directoryTree\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dataloop.DatasetDirectoryTree.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::Dataloop.DatasetDirectoryTree>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dataloop.DatasetDirectoryTree.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
