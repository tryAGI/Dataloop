            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Dataloop.DatasetDirectoryTree.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Dataloop.DatasetDirectoryTree.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
