            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Dataloop.TriggerResourceInformationPage.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Dataloop.TriggerResourceInformationPage.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
