...
namespace Dataloop
{
    public partial class ItemsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_StreamItemThumbnailSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_StreamItemThumbnailSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_StreamItemThumbnailSecurityRequirement0,
            };
        partial void PrepareStreamItemThumbnailArguments(
        ...
        partial void PrepareStreamItemThumbnailRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? annotationsV2,
            string? queryHash);
        partial void ProcessStreamItemThumbnailResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task StreamItemThumbnailAsync(
            string id,
        ...
        {
            await StreamItemThumbnailAsResponseAsync(
                id: id,
                width: width,
                height: height,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> StreamItemThumbnailAsResponseAsync(
            string id,
            double? width = default,
            double? height = default,
            bool? annotations = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareStreamItemThumbnailArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StreamItemThumbnailSecurityRequirements,
                operationName: "StreamItemThumbnailAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StreamItemThumbnail",
                                methodName: "StreamItemThumbnailAsync",
                                pathTemplate: "$\"/items/{id}/thumbnail\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStreamItemThumbnailResponse(
                    httpClient: HttpClient,
