...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_EditPipelinesByPipelineIdSettingsSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_EditPipelinesByPipelineIdSettingsSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_EditPipelinesByPipelineIdSettingsSecurityRequirement0,
            };
        partial void PrepareEditPipelinesByPipelineIdSettingsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string pipelineId);
        partial void PrepareEditPipelinesByPipelineIdSettingsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string pipelineId);
        partial void ProcessEditPipelinesByPipelineIdSettingsResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task EditPipelinesByPipelineIdSettingsAsync(
            string pipelineId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEditPipelinesByPipelineIdSettingsArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditPipelinesByPipelineIdSettingsSecurityRequirements,
                operationName: "EditPipelinesByPipelineIdSettingsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditPipelinesByPipelineIdSettingsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editPipelinesByPipelineIdSettings",
                                methodName: "EditPipelinesByPipelineIdSettingsAsync",
                                pathTemplate: "$\"/pipelines/{pipelineId}/settings\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditPipelinesByPipelineIdSettingsResponse(
                    httpClient: HttpClient,
