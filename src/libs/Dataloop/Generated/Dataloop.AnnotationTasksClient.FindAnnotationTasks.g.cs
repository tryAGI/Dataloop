...
namespace Dataloop
{
    public partial class AnnotationTasksClient
    {
        ...
        {
            var __response = await FindAnnotationTasksAsResponseAsync(
                projects: projects,
                dataset: dataset,
                recipe: recipe,
                status: status,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.APITaskCursor>> FindAnnotationTasksAsResponseAsync(
            global::System.Collections.Generic.IList<string>? projects = default,
            string? dataset = default,
            string? recipe = default,
            string? status = default,
