...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_CreateExecutionsByServiceIdSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_CreateExecutionsByServiceIdSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_CreateExecutionsByServiceIdSecurityRequirement0,
            };
        partial void PrepareCreateExecutionsByServiceIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string serviceId);
        partial void PrepareCreateExecutionsByServiceIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string serviceId);
        partial void ProcessCreateExecutionsByServiceIdResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreateExecutionsByServiceIdAsync(
            string serviceId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateExecutionsByServiceIdArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateExecutionsByServiceIdSecurityRequirements,
                operationName: "CreateExecutionsByServiceIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateExecutionsByServiceIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createExecutionsByServiceId",
                                methodName: "CreateExecutionsByServiceIdAsync",
                                pathTemplate: "$\"/executions/{serviceId}\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateExecutionsByServiceIdResponse(
                    httpClient: HttpClient,
