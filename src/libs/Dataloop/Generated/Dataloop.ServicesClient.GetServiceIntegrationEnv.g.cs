...
namespace Dataloop
{
    public partial class ServicesClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_GetServiceIntegrationEnvSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_GetServiceIntegrationEnvSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_GetServiceIntegrationEnvSecurityRequirement0,
            };
        ...
        {
            var __response = await GetServiceIntegrationEnvAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.GetServiceIntegrationEnvResponse>> GetServiceIntegrationEnvAsResponseAsync(
            string id,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetServiceIntegrationEnvSecurityRequirements,
                operationName: "GetServiceIntegrationEnvAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetServiceIntegrationEnv",
                                methodName: "GetServiceIntegrationEnvAsync",
                                pathTemplate: "$\"/services/{id}/integration-env\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dataloop.GetServiceIntegrationEnvResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::Dataloop.GetServiceIntegrationEnvResponse>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dataloop.GetServiceIntegrationEnvResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
