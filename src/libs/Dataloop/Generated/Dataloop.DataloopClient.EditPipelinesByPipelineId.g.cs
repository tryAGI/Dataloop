...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_EditPipelinesByPipelineIdSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_EditPipelinesByPipelineIdSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_EditPipelinesByPipelineIdSecurityRequirement0,
            };
        partial void PrepareEditPipelinesByPipelineIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string pipelineId);
        partial void PrepareEditPipelinesByPipelineIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string pipelineId);
        partial void ProcessEditPipelinesByPipelineIdResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task EditPipelinesByPipelineIdAsync(
            string pipelineId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEditPipelinesByPipelineIdArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EditPipelinesByPipelineIdSecurityRequirements,
                operationName: "EditPipelinesByPipelineIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEditPipelinesByPipelineIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "editPipelinesByPipelineId",
                                methodName: "EditPipelinesByPipelineIdAsync",
                                pathTemplate: "$\"/pipelines/{pipelineId}\"",
                                httpMethod: "PATCH",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEditPipelinesByPipelineIdResponse(
                    httpClient: HttpClient,
