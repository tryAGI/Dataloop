...
namespace Dataloop
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_RemoveAccountFromOrgSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_RemoveAccountFromOrgSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_RemoveAccountFromOrgSecurityRequirement0,
            };
        partial void PrepareRemoveAccountFromOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            ref string accountId);
        partial void PrepareRemoveAccountFromOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId,
            string accountId);
        partial void ProcessRemoveAccountFromOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task RemoveAccountFromOrgAsync(
            string orgId,
            string accountId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await RemoveAccountFromOrgAsResponseAsync(
                orgId: orgId,
                accountId: accountId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> RemoveAccountFromOrgAsResponseAsync(
            string orgId,
            string accountId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRemoveAccountFromOrgArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveAccountFromOrgSecurityRequirements,
                operationName: "RemoveAccountFromOrgAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRemoveAccountFromOrgRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RemoveAccountFromOrg",
                                methodName: "RemoveAccountFromOrgAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemoveAccountFromOrgResponse(
                    httpClient: HttpClient,
