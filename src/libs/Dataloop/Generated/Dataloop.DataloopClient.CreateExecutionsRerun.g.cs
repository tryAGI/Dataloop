...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_CreateExecutionsRerunSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_CreateExecutionsRerunSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_CreateExecutionsRerunSecurityRequirement0,
            };
        partial void PrepareCreateExecutionsRerunArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareCreateExecutionsRerunRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessCreateExecutionsRerunResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreateExecutionsRerunAsync(
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateExecutionsRerunArguments(
                httpClient: HttpClient);


            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_CreateExecutionsRerunSecurityRequirements,
                operationName: "CreateExecutionsRerunAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateExecutionsRerunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createExecutionsRerun",
                                methodName: "CreateExecutionsRerunAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateExecutionsRerunResponse(
                    httpClient: HttpClient,
