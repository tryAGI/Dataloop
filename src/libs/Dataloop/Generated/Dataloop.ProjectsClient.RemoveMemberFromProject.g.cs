...
namespace Dataloop
{
    public partial class ProjectsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_RemoveMemberFromProjectSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_RemoveMemberFromProjectSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_RemoveMemberFromProjectSecurityRequirement0,
            };
        partial void PrepareRemoveMemberFromProjectArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string projectId,
            ref string userId);
        partial void PrepareRemoveMemberFromProjectRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string projectId,
            string userId);
        partial void ProcessRemoveMemberFromProjectResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRemoveMemberFromProjectResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await RemoveMemberFromProjectAsResponseAsync(
                projectId: projectId,
                userId: userId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRemoveMemberFromProjectArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RemoveMemberFromProjectSecurityRequirements,
                operationName: "RemoveMemberFromProjectAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "RemoveMemberFromProjectAsync",
                                pathTemplate: "$\"/projects/{projectId}/members/{userId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRemoveMemberFromProjectResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRemoveMemberFromProjectResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Dataloop.ClientContributor>?)global::System.Text.Json.JsonSerializer.Deserialize(__content, typeof(global::System.Collections.Generic.IList<global::Dataloop.ClientContributor>), JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::System.Collections.Generic.IList<global::Dataloop.ClientContributor>>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = (global::System.Collections.Generic.IList<global::Dataloop.ClientContributor>?)await global::System.Text.Json.JsonSerializer.DeserializeAsync(__content, typeof(global::System.Collections.Generic.IList<global::Dataloop.ClientContributor>), JsonSerializerContext).ConfigureAwait(false) ??
