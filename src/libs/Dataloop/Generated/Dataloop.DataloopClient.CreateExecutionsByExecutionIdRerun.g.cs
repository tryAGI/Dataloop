...
namespace Dataloop
{
    public partial class DataloopClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_CreateExecutionsByExecutionIdRerunSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_CreateExecutionsByExecutionIdRerunSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_CreateExecutionsByExecutionIdRerunSecurityRequirement0,
            };
        partial void PrepareCreateExecutionsByExecutionIdRerunArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string executionId);
        partial void PrepareCreateExecutionsByExecutionIdRerunRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string executionId);
        partial void ProcessCreateExecutionsByExecutionIdRerunResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        /// # 
        /// </remarks>
        public async global::System.Threading.Tasks.Task CreateExecutionsByExecutionIdRerunAsync(
            string executionId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateExecutionsByExecutionIdRerunArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateExecutionsByExecutionIdRerunSecurityRequirements,
                operationName: "CreateExecutionsByExecutionIdRerunAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateExecutionsByExecutionIdRerunRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createExecutionsByExecutionIdRerun",
                                methodName: "CreateExecutionsByExecutionIdRerunAsync",
                                pathTemplate: "$\"/executions/{executionId}/rerun\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateExecutionsByExecutionIdRerunResponse(
                    httpClient: HttpClient,
