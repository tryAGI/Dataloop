...
namespace Dataloop
{
    public partial class ExecutionsClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.ExecutionsPage>> ListExecutionsAsResponseAsync(
            string? projectsQuery = default,
            string? service = default,
            string? trigger = default,
            string? functionName = default,
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dataloop.ExecutionsPage.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::Dataloop.ExecutionsPage>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dataloop.ExecutionsPage.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
