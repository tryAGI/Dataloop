...
namespace Dataloop
{
    ...
    public sealed partial class CursorPageAPIPipelineState
    {
        ...
        [global::System.Text.Json.Serialization.JsonRequired]
        public required global::System.Collections.Generic.IList<global::Dataloop.APIPipelineState> Items { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CursorPageAPIPipelineState" /> class.
        /// </summary>
...
#endif
        public CursorPageAPIPipelineState(
            bool hasNextPage,
            double totalPagesCount,
            global::System.Collections.Generic.IList<global::Dataloop.APIPipelineState> items,
