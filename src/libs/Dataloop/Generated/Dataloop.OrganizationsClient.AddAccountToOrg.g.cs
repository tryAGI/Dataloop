...
namespace Dataloop
{
    public partial class OrganizationsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_AddAccountToOrgSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_AddAccountToOrgSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_AddAccountToOrgSecurityRequirement0,
            };
        partial void PrepareAddAccountToOrgArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            ref string accountId);
        partial void PrepareAddAccountToOrgRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId,
            string accountId);
        partial void ProcessAddAccountToOrgResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessAddAccountToOrgResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dataloop.APIOrg> AddAccountToOrgAsync(
            string orgId,
            string accountId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await AddAccountToOrgAsResponseAsync(
                orgId: orgId,
                accountId: accountId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.APIOrg>> AddAccountToOrgAsResponseAsync(
            string orgId,
            string accountId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareAddAccountToOrgArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_AddAccountToOrgSecurityRequirements,
                operationName: "AddAccountToOrgAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "AddAccountToOrg",
                                methodName: "AddAccountToOrgAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessAddAccountToOrgResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessAddAccountToOrgResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
