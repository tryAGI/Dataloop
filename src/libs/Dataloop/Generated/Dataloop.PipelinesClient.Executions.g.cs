            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Dataloop.CursorPageAPIPipelineState.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Dataloop.CursorPageAPIPipelineState.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
