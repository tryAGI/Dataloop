...
namespace Dataloop
{
    public partial class PipelinesClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_ExecutionsSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_ExecutionsSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_ExecutionsSecurityRequirement0,
            };
        ...
        {
            var __response = await ExecutionsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.CursorPageAPIPipelineState>> ExecutionsAsResponseAsync(
            string pipelineId,
            string? filter = default,
            string? sort = default,
            string? page = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ExecutionsSecurityRequirements,
                operationName: "ExecutionsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "ExecutionsAsync",
                                pathTemplate: "$\"/pipelines/{pipelineId}/executions\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dataloop.CursorPageAPIPipelineState.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::Dataloop.CursorPageAPIPipelineState>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dataloop.CursorPageAPIPipelineState.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
