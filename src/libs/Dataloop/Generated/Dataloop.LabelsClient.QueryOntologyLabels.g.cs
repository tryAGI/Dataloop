...
namespace Dataloop
{
    public partial class LabelsClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_QueryOntologyLabelsSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_QueryOntologyLabelsSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_QueryOntologyLabelsSecurityRequirement0,
            };
        partial void PrepareQueryOntologyLabelsArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string ontologyId,
            global::Dataloop.FilterQueryInput request);
        partial void PrepareQueryOntologyLabelsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string ontologyId,
            global::Dataloop.FilterQueryInput request);
        partial void ProcessQueryOntologyLabelsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessQueryOntologyLabelsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Dataloop.CursorPageAPILabelTreeNodeV2> QueryOntologyLabelsAsync(
            string ontologyId,
        ...
        {
            var __response = await QueryOntologyLabelsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.CursorPageAPILabelTreeNodeV2>> QueryOntologyLabelsAsResponseAsync(
            string ontologyId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareQueryOntologyLabelsArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_QueryOntologyLabelsSecurityRequirements,
                operationName: "QueryOntologyLabelsAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Dataloop.PathBuilder(
                                path: $"/ontologies/{ontologyId}/labels/query",
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareQueryOntologyLabelsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "QueryOntologyLabels",
                                methodName: "QueryOntologyLabelsAsync",
                                pathTemplate: "$\"/ontologies/{ontologyId}/labels/query\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessQueryOntologyLabelsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessQueryOntologyLabelsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Dataloop.CursorPageAPILabelTreeNodeV2.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Dataloop.AutoSDKHttpResponse<global::Dataloop.CursorPageAPILabelTreeNodeV2>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Dataloop.CursorPageAPILabelTreeNodeV2.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await QueryOntologyLabelsAsync(
                ontologyId: ontologyId,
                request: __request,
                requestOptions: requestOptions,
