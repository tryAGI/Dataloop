...
namespace Dataloop
{
    public partial class ComputeClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_DeleteRegistryCredSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_DeleteRegistryCredSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_DeleteRegistryCredSecurityRequirement0,
            };
        partial void PrepareDeleteRegistryCredArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string orgId,
            ref string integrationId);
        partial void PrepareDeleteRegistryCredRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string orgId,
            string integrationId);
        partial void ProcessDeleteRegistryCredResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task DeleteRegistryCredAsync(
            string orgId,
            string integrationId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await DeleteRegistryCredAsResponseAsync(
                orgId: orgId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> DeleteRegistryCredAsResponseAsync(
            string orgId,
            string integrationId,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDeleteRegistryCredArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DeleteRegistryCredSecurityRequirements,
                operationName: "DeleteRegistryCredAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDeleteRegistryCredRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DeleteRegistryCred",
                                methodName: "DeleteRegistryCredAsync",
                                pathTemplate: "$\"/compute/registry/orgs/{orgId}/integrations/{integrationId}\"",
                                httpMethod: "DELETE",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDeleteRegistryCredResponse(
                    httpClient: HttpClient,
