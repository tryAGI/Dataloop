...
namespace Dataloop
{
    public partial class TasksClient
    {
        ...
        {
            var __response = await UpdateTaskAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse<global::Dataloop.APITask>> UpdateTaskAsResponseAsync(
            string id,
