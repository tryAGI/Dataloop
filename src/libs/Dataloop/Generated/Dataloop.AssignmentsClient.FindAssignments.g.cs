            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                try
                {
                    ...
                    return
                        global::Dataloop.APIAssignmentCursor.FromJson(__content, JsonSerializerOptions) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Dataloop.APIAssignmentCursor.FromJsonStreamAsync(__content, JsonSerializerOptions).ConfigureAwait(false) ??
