...
namespace Dataloop
{
    public partial class InvoicesClient
    {
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement s_StreamInvoicePdfSecurityRequirement0 =
        ...
        private static readonly global::Dataloop.EndPointSecurityRequirement[] s_StreamInvoicePdfSecurityRequirements =
            new global::Dataloop.EndPointSecurityRequirement[]
            {                s_StreamInvoicePdfSecurityRequirement0,
            };
        partial void PrepareStreamInvoicePdfArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string id);
        partial void PrepareStreamInvoicePdfRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id);
        partial void ProcessStreamInvoicePdfResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task StreamInvoicePdfAsync(
            string id,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            await StreamInvoicePdfAsResponseAsync(
                id: id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> StreamInvoicePdfAsResponseAsync(
            string id,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareStreamInvoicePdfArguments(
            ...
            var __authorizations = global::Dataloop.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_StreamInvoicePdfSecurityRequirements,
                operationName: "StreamInvoicePdfAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareStreamInvoicePdfRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "StreamInvoicePdf",
                                methodName: "StreamInvoicePdfAsync",
                                pathTemplate: "$\"/invoices/{id}/stream\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessStreamInvoicePdfResponse(
                    httpClient: HttpClient,
