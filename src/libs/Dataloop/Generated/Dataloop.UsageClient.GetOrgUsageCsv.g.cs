...
namespace Dataloop
{
    public partial class UsageClient
    {
        ...
        partial void PrepareGetOrgUsageCsvArguments(
            ...
            ref string endDate);
        partial void PrepareGetOrgUsageCsvRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string id,
            string startDate,
            string endDate);
        partial void ProcessGetOrgUsageCsvResponse(
            global::System.Net.Http.HttpClient httpClient,
        ...
        public async global::System.Threading.Tasks.Task GetOrgUsageCsvAsync(
            string id,
            string startDate,
            string endDate,
        ...
        {
            await GetOrgUsageCsvAsResponseAsync(
                id: id,
                startDate: startDate,
                endDate: endDate,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Dataloop.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Dataloop.AutoSDKHttpResponse> GetOrgUsageCsvAsResponseAsync(
            string id,
            string startDate,
            string endDate,
            global::Dataloop.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetOrgUsageCsvArguments(
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Dataloop.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Dataloop.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "GetOrgUsageCsv",
                                methodName: "GetOrgUsageCsvAsync",
                                pathTemplate: "$\"/usage/orgs/{id}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
